...
Small datasets are often stored as Excel files.  Although there are R packages designed to read Excel (xls/xlsx) format, you generally want
to avoid this and save files as comma delimited (Comma-Separated
Value/CSV) or tab delimited (Tab-Separated Value/TSV) files.
